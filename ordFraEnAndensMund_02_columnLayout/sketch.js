...
let personaOneliners = ["Dagbogsnotater fra en 9-årig pige under lockdown", "Datingprofil for en kvinde i 40'erne under lockdown", "Oplevelser fra en indespæret kat under lockdown", "Digt fra en kassemedarbejder i Netto under lockdown", "Digt fra ensom teenagepige under lockdown"]
...
function preload() {
  for (let i = 0; i < n; i++) {
    ...
    personaCounters[i] = floor(random(n)); //sloppy
