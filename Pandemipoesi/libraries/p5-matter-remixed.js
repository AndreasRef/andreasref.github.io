...
var matter = (function() {
    ...
    var Sign = function(text, x, y, options) {
      this.text = text;
      Block.call(this, x, y, textWidth(text), textSize(), options); //Here I can abitrarily make the stuff smaller
    };
    ...
    Sign.prototype.show = function() {
      ...
      //Manually added black rectangle
      push();
      translate(this.getPositionX(),this.getPositionY());
      rotate(this.getAngle());
      fill(0)
      ...
      //Text
      push();
      //translate(this.getPositionX(), this.getPositionY() + this.getHeight() * 0.25); // original
      translate(this.getPositionX(), this.getPositionY() ); // original
      rotate(this.getAngle());
      textAlign(CENTER);
      text(this.getText(), 0, 0 + this.getHeight() * 0.25);
      pop();
    };
