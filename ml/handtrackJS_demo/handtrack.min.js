...
a.beginPath(),a.fillStyle="rgba(255, 255, 255, 0.6)",a.fillRect(e[r].bbox[0],e[r].bbox[1]-17,e[r].bbox[2],17),a.rect(...e[r].bbox),a.lineWidth=1,a.strokeStyle="#FF0000",a.fillStyle="#FF0000",a.fillRect(e[r].bbox[0]+e[r].bbox[2]/2,e[r].bbox[1]+e[r].bbox[3]/2,5,5),a.stroke(),a.fillText(e[r].score.toFixed(3)+"  | hand",e[r].bbox[0]+5,10<e[r].bbox[1]?e[r].bbox[1]-5:10);
