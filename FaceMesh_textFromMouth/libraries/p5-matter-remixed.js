...
var matter = (function() {
    ...
    var Sign = function(text, x, y, options) {
      this.text = text;
      Block.call(this, x, y, textWidth(text)-0, textSize()-0, options); //Here I abitrarily make the stuff smaller
    };
    ...
    //MY OWN FUNCTION TO MAKE A BACKGROUND FOR EACH SIGN
    Sign.prototype.showBG = function() {
      push();
      translate(this.getPositionX(), this.getPositionY() + this.getHeight() * 0.25);
      rotate(this.getAngle());
      //textAlign(CENTER);
      //text(this.getText(), 0, 0);
      rectMode(CENTER)
      rect(0,-this.getHeight() * 0.25, this.getWidth(), this.getHeight())
      pop();
    };
