...
NN.IMAGES_SPRITE_PATH ='https://cdn.glitch.com/020962cd-097d-4482-80ac-da19c192c845%2Fquickdraw_image_345.png?1556314487943';
NN.LABELS_PATH ='https://cdn.glitch.com/020962cd-097d-4482-80ac-da19c192c845%2Fquickdraw_labels_uint8_345?1556314443647';
NN.EPOCHS = 100;
NN.model = undefined;
NN.data = undefined;
NN.DESCRIPTION = `A <i>Quick, Draw!</i> knock-off based on a ConvNet for MNIST trained on ${NN.CLASSES.length} classes from the quickdraw dataset`
...
NN.loadModel = async function(){
  NN.model = await tf.loadLayersModel('models/tfjs-model-8476688572242683.json');
}
...
NN.train = async function train() {
  ...
  function evaluateTest(epoch){
    ...
    ctx_g.fillStyle = "red";
    ctx_g.fillRect(canv_g.width * (epoch+1)/NN.EPOCHS, canv_g.height*(1-testResult[1].dataSync()[0]), canv_g.width, 1);
  }
