var Node = function(x, y, minX, maxX, minY, maxY, concept) {
  ...
  this.radius = 250; // Radius of impact
...
Node.prototype.attract = function(otherNode) {
  var thisNodeVector = createVector(this.x, this.y);
  var otherNodeVector = createVector(otherNode.x, otherNode.y);
